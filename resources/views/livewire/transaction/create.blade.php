            ...
            <form wire:submit.prevent="store">
                ...
                <div class="flex-row item-end">
                    <div class="text-right mr-4">
                        <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 mr-4">Unit Price</label>
                        <span>${{ $price }}</span>
                    </div>
                    <div class="text-right mr-4">
                        <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700 mr-4">Amount</label>
                        <span>${{ $amount }}</span>
                    </div>
                </div>
